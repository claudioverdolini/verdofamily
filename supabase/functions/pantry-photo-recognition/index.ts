      ...
      properties: {
        items: {
          ...
          items: {
            ...
            required: ["detectedName", "matchName", "qty", "unit", "category", "confidence", "observedText", "notes"]
          }
        }
      },
      required: ["items"]
